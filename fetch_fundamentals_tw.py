...
MAX_RUNTIME_MIN = int(os.environ.get("TW_MAX_RUNTIME_MIN", "45"))
TW_WORKERS      = int(os.environ.get("TW_WORKERS", "8"))   # 平行抓取執行緒(付費Backer 1600/hr→可較高並行)
...
PICKS = [
    ...
    "2395","2412","9917","6739",
    # 新 IPO
    "2645","6690","4569","4904","2344",
    # AI 應用層(Edge AI / ASIC / 雲伺服器)
    "2454","3443","6669",
]
