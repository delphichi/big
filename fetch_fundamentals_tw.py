...
=======================================================================
名單 = 月營收年增掃描中表現最好的一批標的(共 179 檔,含金融股,見 PICKS)。
...
# 名單 = 月營收年增掃描中表現最好的一批標的 = 179 檔(含金融股,口徑不適用者輸出會標 🏦)。
...
PICKS = [
    ...
    # 0050 blind spot 補抓:TWSE rank 51-90 但 PICKS 沒有的(已排除純循環/航運/面板)
    # 補完後可在 0050 納入預測 候選A 直接出現
    "3661","2313","2337","6515","3533","3034","6239","1590","2207","2356",
    "2404","6415","6139","1504","1605",
    # 富櫃50 blind spot + OTC 轉上市觀察:OTC rank 51-90 + 大型 OTC(轉上市即進 0050)
    "3227","5371","8086","5351","4123","6613","3357","5439","5425","6640",
    "5347","3529","8069","3081","6147","6488",
]
